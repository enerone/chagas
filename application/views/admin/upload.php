<html>
	...
	<link rel="stylesheet" href="http://code.jquery.com/ui/1.10.2/themes/smoothness/jquery-ui.css" id="theme">
...
<div id="fileupload">
    <form action="upload/do_upload" method="POST" enctype="multipart/form-data">
        <div class="fileupload-buttonbar">
            ...
            <button type="button" class="btn btn-danger delete">Delete files</button>
        </div>
    </form>
