<div class="table">
    <?php echo form_open_multipart(base_url().'admin/noticias/crea'); ?>
    <table class="listing form" cellpadding="0" cellspacing="0">
        
        <tr>
            <th class="full" colspan="2">Creaci&oacute;n de Noticias</th>
        </tr>
        <tr>
        ...
        echo form_dropdown('item[empresa]', $empresa,'', $conf_drop);
        ?>
        </td>
        </tr>
        <tr>
            <td width="172"><strong>Fecha de la nota</strong></td>
            <td><input type="text" name="item[fecha1]" id="fecha_nota" class="text" /></td>
        </tr>
          <tr>
            <td width="172"><strong>Volanta</strong></td>
            <td><input type="text" name="item[volanta]" class="text" /></td>
        </tr>
        <tr>
         ...
         <tr>
            ...
            <td><input type="text" name="item[autor]" class="text" /></td>
        </tr>
        ...
        <tr>
            ...
            <td>
               <?php $this->ckeditor->editor("item[copete]", "",$config); ?>
        ...
        <tr>
            ...
            <td><input type="text" name="item[fuente]" class="text" /></td>
        </tr>
        <tr>
            <td width="172"><strong>Permalink</strong></td>
            <td><input type="text" name="item[permalink]" class="text" /></td>
        </tr>
