<style>
	...
	<tr class="row1 trborde" >
		<td>
			...
			<input type="checkbox"  name="vivienda_cerrada" id="vivienda_cerrada"  value="1" class="campos_check anulador"   />
			
			Vivienda Renuente: 
			<input type="hidden"  name="vivienda_renuente" value="0"   />
			<input type="checkbox"  name="vivienda_renuente" id="vivienda_renuente" value="1" class="campos_check anulador"   />
     ...
     $(function() {
       ...
       rules: {
            ...
            gramos_aplicados: {
            	required: {
		          depends: function(element) {
		          	if($("#vivienda_cerrada").is(':checked') || $("#vivienda_cerrada").is(':checked')){
		          		return false;
		          	}else{
			          	if($("#control_quimico").is(':checked') ){
			          			return true;
			          	}else{
			          		return false;
			          	}
